...
//                   <h5 className="mt-2 text-success p mb-0">
...
//                   </h5>
//                   <div className="ms-3 mt-2 text-danger">
...
//             <div className="mb-4">
//             <label className="form-label" htmlFor="resume">Cover Letter (optional):</label>
//               <textarea name="" rows={5} className="form-control" id=""></textarea>
//             </div>

//             <div className="mb-3">
//             <label className="form-label" htmlFor="resume">Upload Certificate (optional):</label>
//               <input type="file" multiple className="form-control" />
//             </div>

//             <button className="btn btn-register rounded-2 py-3 fs-6 w-100 mt-3" type="submit">Apply</button>
//           </form>

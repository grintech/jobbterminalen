...
const SignUp = () => {
  ...
  return (
    <>
        ...
        <div className="recruiter_signup_form py-4">
        <div className="container-fluid px-5">
            <div className="d-flex align-items-center justify-content-between mb-3">
                <h4>Create Recruiter Profile</h4>
                <small>Existing Employers/Recruiters? <Link className='text-primary'>Login</Link></small>
            </div>
            <form id="signup_form">
                <div className="row">
                    <div className="col-lg-4">
                        <div className="card personal_detail_card">
                                ...
                                <div className="col-12 ">
                                        <div className="d-flex">
                                            <div className="col-6 px-1">
                                                ...
                                                <input type="text" className='w-100 form-control' placeholder='First Name' />
                                            </div>
                                            <div className="col-6 px-1">
                                                <label htmlFor="">Last Name <span>*</span></label>
                                                <input type="text" className='w-100 form-control' placeholder='Last Name' />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="col-lg-8">
                        <div className="card">
                            <div className="card-body">
                            <h6 className='fw-bold'>Professional Details</h6>
                            <div className="mb-4">
                                <div className="row">
                            ...
                            <div className='previous_company bg-light py-3 px-3 '>

...
const MyAccount = () => {
  ...
  const handleCertificateChange = (e) => {
    ...
    setSelectedCertificate((prev) => ({
      ...
      ...(name === 'lifetime_validity' && checked ? { certification_validity: 'Lifetime', expire_on: '' } : {}),
      ...(name === 'certification_validity' && value !== 'Lifetime' ? { lifetime_validity: false } : {}),
    }));
  };
...
// useEffect(() => {
//   if (certificates?.certification_name) {
//     toast.success(`Certificates: ${certificates.certification_name}`);
//   } else {
